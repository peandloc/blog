			...
			<div class="line-big">
				<div class="xl12 xm8">
					<div class="line-small">
						<div class="xs12">
							<?php if(is_array($list)): foreach($list as $key=>$vo): ?><div class="clearfix articlebox">
									<div class="detail_a">
									...
									<div class="look-all">
										<a href="<?php echo U('Article/index',array('a_id'=>$vo['a_id']));?>" class="button border-blue" role="button">查看文章</a>
									</div>
								</div>
	...
	<script>
		...
		$(function(){
		    ...
		    $('#btn_dongtan').click(function(){
		    	...
		    	$.ajax({
                       url: "<?php echo U('Index/dongtan');?>",//'/Home/Index/dongtan',
                       type: "post",
                       data:{
                               'content':dongtan
                            },
